...
//! @sa     GLFWmonitor
//!
//! @warning    This implementation is provisional. Everything will probably be different once I figure out how it
...
public:
    ...
    //! Constructor.
    //!
    //! @param  m       Underlying GLFWmonitor
    ...
    //!
    //! @return     List of copies of the available monitors
    //!
    //! @sa     glfwGetMonitors
    ...
    //!
    //! @return A copy of the primary monitor
    //!
    ...
    //!
    //! @return     List of available video modes
    //!
